...
type EventName =
  ...
  | 'onboarding_plan_selected_free'
  | 'onboarding_plan_selected_paid'
  | 'onboarding_free_activation_succeeded'
  | 'onboarding_free_activation_failed'
  | 'onboarding_checkout_started'
  | 'onboarding_checkout_returned_success'
  | 'onboarding_checkout_returned_cancel'
  | 'onboarding_subscription_confirmed'
