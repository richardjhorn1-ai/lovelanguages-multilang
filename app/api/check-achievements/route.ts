...
import { ACHIEVEMENT_DEFINITIONS, LEVEL_TIERS } from '@/constants/levels';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to check achievements' }, { status: 500, headers: corsHeaders });
  }
}
