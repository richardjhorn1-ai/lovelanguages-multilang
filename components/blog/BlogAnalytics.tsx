...
export default function BlogAnalytics({
  ...
  useEffect(() => {
    // Defer analytics setup until browser is idle (frees main thread for rendering)
    ...
    // Use requestIdleCallback to defer analytics until browser is idle
    let idleId: number | undefined;
    let timeoutId: ReturnType<typeof setTimeout> | undefined;

    if ('requestIdleCallback' in window) {
      idleId = requestIdleCallback(startAnalytics);
    } else {
      timeoutId = setTimeout(startAnalytics, 2000);
    }
