...
const ScenarioSelector: React.FC<ScenarioSelectorProps> = ({ onSelect, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 modal-backdrop flex items-center justify-center z-50 p-4">
      <div className="glass-card-solid rounded-[2rem] w-full max-w-lg max-h-[85vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-3">
          {!showCustom ? (
            <>
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 glass-card rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform text-purple-500">
                    <ICONS.Sparkles className="w-6 h-6" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-bold font-header text-purple-700 dark:text-purple-300">{t('scenarioSelector.createOwn')}</h3>
            ...
            <>
              ...
              <div>
                ...
                <div className="text-center mb-6">
                  <div className="mb-2 text-purple-500"><ICONS.Sparkles className="w-10 h-10 mx-auto" /></div>
