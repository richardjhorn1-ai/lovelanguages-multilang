...
export const TOPIC_DEFINITIONS: Record<string, { patterns: string[]; icon: string }> = {
  'pet-names': { patterns: ['pet-names', 'terms-of-endearment'], icon: '\u{1F495}' },
  'i-love-you': { patterns: ['how-to-say-i-love-you'], icon: '\u{2764}\u{FE0F}' },
  'pronunciation': { patterns: ['pronunciation-guide'], icon: '\u{1F5E3}\u{FE0F}' },
  'grammar-basics': { patterns: ['grammar-basics'], icon: '\u{1F4DD}' },
  'essential-phrases': { patterns: ['essential-phrases'], icon: '\u{1F4AC}' },
  'romantic-phrases': { patterns: ['romantic-phrases'], icon: '\u{1F498}' },
};
