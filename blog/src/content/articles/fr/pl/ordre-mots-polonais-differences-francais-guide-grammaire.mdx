---
title: "L'ordre des mots en polonais : Différences avec le français (Guide de grammaire pour couples)"
...
<VocabCard
  ...
  example="Marię kocha Jan = Jan aime Maria (même sens, emphase différente)"
/>
...
<CultureTip title="Astuce romance" flag="🇵🇱">
...
<VocabCard
  ...
  example="Czy kochasz mnie? = Est-ce que tu m'aimes ? (avec particule interrogative)"
/>
...
<VocabCard
  ...
  example="Nie rozumiem tego słowa = Je ne comprends pas ce mot"
/>
...
<CultureTip title="Conseil d'apprentissage en couple" flag="🇵🇱">
