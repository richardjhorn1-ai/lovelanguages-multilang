...
description: "Naucz sie poprawnej wymowy greckiej. Kompletny przewodnik dla polskich par uczacych sie jezyka razem."
...
Grecka wymowa moze wydawac sie trudna ze wzgledu na inny alfabet, ale wiele dzwiekow jest podobnych do polskich! Ten przewodnik pomoze wam jako parze opanowac grecka wymowe razem.
...
<VocabCard
  ...
  translation="moge"
  pronunciation="bo-RO"
  example="'μπ' na poczatku slowa = 'b'"
/>
...
Akcent jest bardzo wazny w greckim. Niektore slowa zmienia znaczenie w zaleznosci od akcentu: "νόμος" (NO-mos) = prawo, "νομός" (no-MOS) = prefektura.
</CultureTip>
...
- **[Jak powiedziec "kocham cie"](/learn/el/how-to-say-i-love-you-in-greek/)** - Praktykuj romantyczne zwroty
...
- **[Czy grecki jest trudny?](/learn/el/is-greek-hard-to-learn/)** - Realistyczne podejscie
