...
Limba daneză are câteva sunete unice care nu există în română. Dar nu te îngrijora - gândește-te la ele ca la o aventură pe care o explorezi împreună cu partenerul tău. Spre deosebire de română, daneza are:
...
Vocalele sunt inima pronunției daneze. Iată-le pe cele mai importante:
...
<VocabCard
  ...
  example="Kærlighed ved første blik" (dragoste la prima vedere)
/>
...
<VocabCard
  ...
  pronunciation="smook"
  example="Du ser smuk ud i aften" (Arăți superb în seara asta)
/>
